...
def bundle_deps():
    ...
    deps_to_copy = ['/usr/bin/Xvfb', '/usr/bin/vncserver','/usr/bin/openbox-lxde', '/usr/bin/startlxde','/usr/bin/google-chrome-stable','/usr/bin/fluxbox','/usr/bin/startfluxbox','/usr/bin/google-chrome','/usr/bin/xauth','/usr/bin/Xtigervnc' ]
